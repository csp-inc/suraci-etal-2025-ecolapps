...
age_sex <- read.csv("age-sex-class-RSFs/Suraci_etal_2025_AgeSexRSF_covariates_disp_fem.csv")
group <- "disp-fem"
...
age_sex_models_top_nh <- age_sex_models$nh9
...
age_sex_models_final[[2]] <- ksModel(age_sex, nh9)
age_sex_models_final[[3]] <- ksModel(age_sex, df_combo1)
age_sex_models_final[[4]] <- ksModel(age_sex, df_combo2)
age_sex_models_final[[5]] <- ksModel(age_sex, df_combo3)
age_sex_models_final[[6]] <- ksModel(age_sex, null_mod)

names(age_sex_models_final) <- c('human8','nh9','df_combo1', 'df_combo2', 'df_combo3', 'null_mod')
...
# save top model
age_sex_models_final_top <- age_sex_models_final$nh9
