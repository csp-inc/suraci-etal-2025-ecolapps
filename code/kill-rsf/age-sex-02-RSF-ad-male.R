## ---------------------------
##
## Script name: age-sex-02-RSF-ad-male.R
##
## Purpose: Fits RSF models for adult male pumas and then performs a model 
## selection routine
##
## Author: Mae Lacey
##
...
age_sex <- read.csv("age-sex-class-RSFs/Suraci_etal_2025_AgeSexRSF_covariates_ad_male.csv")
group <- "ad-male"
...
age_sex_models_top_nh <- age_sex_models$nh11
...
age_sex_models_final[[2]] <- ksModel(age_sex, nh11)
age_sex_models_final[[3]] <- ksModel(age_sex, am_combo1)
age_sex_models_final[[4]] <- ksModel(age_sex, am_combo2)
age_sex_models_final[[5]] <- ksModel(age_sex, am_combo3)
age_sex_models_final[[6]] <- ksModel(age_sex, null_mod)

names(age_sex_models_final) <- c('human8','nh11','am_combo1', 'am_combo2', 'am_combo3', 'null_mod')
...
# save top model
age_sex_models_final_top <- age_sex_models_final$nh11
