...
save(cov_extract_df, file = "age-sex-class-RSFs/age_sex_RSF_covariate_extract_for_SOE.rda")
...
save(mod_list, mod_list_tab, file = "age-sex-class-RSFs/age_sex_RSF_SOE_models.rda")
...
save(selected_df, file = "age-sex-class-RSFs/age_sex_RSF_covariate_extract_all.rda")
...
write.csv(final_corr, "age-sex-class-RSFs/age_sex_RSF_final_corr.csv") 
save(selected_df, mod_list_tab, final_corr, file = "age-sex-class-RSFs/age_sex_RSF_covExtract_SOE_correlations.rda")


# ------------------------------------------------------------------------------
# CREATE SEPARATE AGE-SEX CLASS DATAFRAMES
# ------------------------------------------------------------------------------
#load("age-sex-class-RSFs/age_sex_RSF_covariate_extract_all.rda") # re-load if needed
...
# subset specific age/sex class:
ad_fem <- subset(all_age_sex, age_sex =="Female_adult")
ad_male <- subset(all_age_sex, age_sex =="Male_adult")
disp_fem <- subset(all_age_sex, age_sex =="Female_disperser")
...
plots
# then export
ggsave(plots, file="age-sex-class-RSFs/age_sex_RSF_final_cov_plots.png",
       width=10, height=7)