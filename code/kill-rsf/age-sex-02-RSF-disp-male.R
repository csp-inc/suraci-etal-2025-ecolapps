## ---------------------------
##
## Script name: age-sex-02-RSF-disp-male.R
##
## Purpose: Fits RSF models for dispersing male pumas and then performs a model 
## selection routine
##
## Author: Mae Lacey
##
...
age_sex <- read.csv("age-sex-class-RSFs/Suraci_etal_2025_AgeSexRSF_covariates_disp_male.csv")
group <- "disp-male"
...
# save top model
age_sex_models_top_human <- age_sex_models$human6
...
age_sex_models_final[[1]] <- ksModel(age_sex, human6)
age_sex_models_final[[2]] <- ksModel(age_sex, nh3)
age_sex_models_final[[3]] <- ksModel(age_sex, dm_combo1)
age_sex_models_final[[4]] <- ksModel(age_sex, dm_combo2)
age_sex_models_final[[5]] <- ksModel(age_sex, null_mod)

names(age_sex_models_final) <- c('human6','nh3','dm_combo1', 'dm_combo2', 'null_mod')
...
# save top model
age_sex_models_final_top <- age_sex_models_final$nh3
